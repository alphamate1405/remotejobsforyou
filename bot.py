"""
Telegram Subscription Bot — Jobs Channel
Powered by Dodo Payments + python-telegram-bot
"""
...
TELEGRAM_CHANNEL_ID  = os.getenv("TELEGRAM_CHANNEL_ID", "@your_channel")   # e.g. -100123456789
